      ...
      <div class="p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <div
            ...
            :key="item.id"
            class="bg-gray-800 p-4 rounded-lg shadow hover:shadow-lg transition"
          >
            <img
              :src="item.image"
              alt="item görsel"
          ...
          <div class="bg-gray-900 p-6 rounded-lg w-full max-w-md relative">
            ...
            <form @submit.prevent="addItem">
              ...
              <div class="mb-3">
                ...
                <input v-model.number="form.damage" class="input-box" required />
              </div>
              <div class="mb-3">
                <label class="text-gray-300">Mermi:</label>
                <input v-model.number="form.ammo" class="input-box" required />
              </div>
              <div class="mb-3">
