      ...
      <div class="flex items-center space-x-4">
        ...
        <NuxtLink to="/cart" class="relative group">
          <svg
            ...
            class="h-6 w-6 text-white group-hover:text-valorantRed transition-all"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <span
            ...
            class="absolute -top-2 -right-2 bg-valorantRed text-white rounded-full w-5 h-5 text-xs flex items-center justify-center"
          >
            {{ cart.items.length }}
          </span>
        </NuxtLink>
        ...
        <NuxtLink v-else to="/login">
          <button
            class="bg-valorantRed px-4 py-2 rounded-lg text-white font-bold hover:opacity-80 transition-all"
          >
            Giriş Yap
          </button>
        </NuxtLink>
